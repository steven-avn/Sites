...
(***********************************************************)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 09/27/2012  AT: 15:39:50        *)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
(* REV HISTORY:                                            *)
...
dvTP_DSTV					=		10001:3:0		//Touch Panel DSTV
...
INTEGER DSTV_BUTTONS[] =  {100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,
...
//-------------------HDPVR 1--------------------//
				 ...
				 CASE 133: PULSE[dvHDPVR1,cdVolUp];
				 CASE 134: PULSE[dvHDPVR1,cdVolDn];
				 CASE 135: PULSE[dvHDPVR1,cdMute];
/*
	 //-------------------HDPVR 2--------------------//
...
//-------------------HDPVR 1--------------------//
				...
				CASE 135:	 PULSE[dvHDPVR1,cd1]		// MM1 HD
								   ...
								   WAIT 7
								   PULSE[dvHDPVR1,cd5]
				CASE 136:	 PULSE[dvHDPVR1,cd1]		// MM2
								   WAIT 4
								   PULSE[dvHDPVR1,cd0]
								   WAIT 7
								   PULSE[dvHDPVR1,cd4]
				CASE 137:	 PULSE[dvHDPVR1,cd1]		// S1 HD
								   WAIT 4
								   PULSE[dvHDPVR1,cd7]
								   WAIT 7
								   PULSE[dvHDPVR1,cd1]
				CASE 138:	 PULSE[dvHDPVR1,cd1]		// S2 HD
								   WAIT 4
								   PULSE[dvHDPVR1,cd7]
								   WAIT 7
								   PULSE[dvHDPVR1,cd4]
	 ...
	 //-------------------HDPVR 2--------------------//
				...
				CASE 173:	 PULSE[dvHDPVR1,cd1]		// MNET HD
								   WAIT 4
								   PULSE[dvHDPVR1,cd7]
								   WAIT 7
								   PULSE[dvHDPVR1,cd0]
				CASE 174:	 PULSE[dvHDPVR1,cd1]		// KYKNET
								   WAIT 4
								   PULSE[dvHDPVR1,cd1]
								   WAIT 7
								   PULSE[dvHDPVR1,cd1]
				CASE 175:	 PULSE[dvHDPVR1,cd1]		// MM1 HD
								   WAIT 4
								   PULSE[dvHDPVR1,cd7]
								   WAIT 7
								   PULSE[dvHDPVR1,cd5]
				CASE 176:	 PULSE[dvHDPVR1,cd1]		// MM2
								   WAIT 4
								   PULSE[dvHDPVR1,cd0]
								   WAIT 7
								   PULSE[dvHDPVR1,cd4]
				CASE 177:	 PULSE[dvHDPVR1,cd1]		// S1 HD
								   WAIT 4
								   PULSE[dvHDPVR1,cd7]
								   WAIT 7
								   PULSE[dvHDPVR1,cd1]
				CASE 178:	 PULSE[dvHDPVR1,cd1]		// S2 HD
								   WAIT 4
								   PULSE[dvHDPVR1,cd7]
								   WAIT 7
								   PULSE[dvHDPVR1,cd4]
