...
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 09/20/2012  AT: 11:08:54        *)
(***********************************************************)
...
vdvGBS_4_DIMMER_1					= 33001:1:1;
vdvGBS_4_DIMMER_2					= 33002:1:1;
vdvGBS_4_DIMMER_3					= 33003:1:1;
...
VOLATILE INTEGER	vGBS_DEVICE_ID_ARRAY[] 	= 	{29,21,6};
...
BUTTON_EVENT[dvTP,16]
{
	PUSH:
	{
		...
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[2]:',ITOA(50)";
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[3]:',ITOA(50)";
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[4]:',ITOA(50)";
	}
}
