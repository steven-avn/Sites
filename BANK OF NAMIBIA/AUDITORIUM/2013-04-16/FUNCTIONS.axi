...
DEFINE_CALL 'PodiumInput'		//PODIUM INPUT
{
	 ...
	 SEND_COMMAND SWITCHER,"'AI5O1,2,3'"		//PODIUM AUDIO/VIDEO IN5 TO OUT ALL
...
DEFINE_CALL 'WallPlateInput'		//WALLPLATE INPUT
{
	 ...
	 SEND_COMMAND SWITCHER,"'AI6O1,2,3'"		//WALLPLATE VIDEO IN6 TO OUT ALL
...
DEFINE_CALL 'PCInput'		//PC INPUT
{
	 ...
	 SEND_COMMAND SWITCHER,"'AI1O1,2,3'"		//PC VIDEO IN1 TO OUT ALL
...
DEFINE_CALL 'VCInput'		//VC INPUT
{
	 ...
	 SEND_COMMAND SWITCHER,"'AI2O1,2,3'"		//VC VIDEO IN2 TO OUT ALL
...
DEFINE_CALL 'DSTVInput'		//DSTV INPUT
{
	 ...
	 SEND_COMMAND SWITCHER,"'AI3O1,2,3'"		//DSTV VIDEO IN3 TO OUT ALL
