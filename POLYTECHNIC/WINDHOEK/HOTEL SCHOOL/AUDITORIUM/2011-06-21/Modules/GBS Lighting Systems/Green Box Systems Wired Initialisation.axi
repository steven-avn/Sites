...
BUTTON_EVENT[dvTP,60]																					//ALL OFF
{
	PUSH:
	{
		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";				//Downlighters 0%
		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[2]:',ITOA(100)";				//Downlighters 0%
...
BUTTON_EVENT[dvTP,68]																						//ALL ON
{
	PUSH:
	{
		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";				//Downlighters 100%
		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[2]:',ITOA(100)";				//Downlighters 100%
