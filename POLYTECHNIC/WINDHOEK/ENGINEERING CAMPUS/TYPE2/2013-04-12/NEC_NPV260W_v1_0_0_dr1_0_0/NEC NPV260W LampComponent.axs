...
(*********************************************************************)
MODULE_NAME = 'NEC NPV260W LampComponent' (dev vdvDev[], dev dvTP, INTEGER nDevice, INTEGER nPages[])
(***********************************************************)
(* System Type : NetLinx                                   *)
...
//
//---------------------------------------------------------------------------------
button_event[dvTP, BTN_SET_LAMP_TIME]
    ...
    push:
    {
        if (bActiveComponent)
		{
			...
			switch (nAdjustType)
			{
				...
				case BTN_SET_LAMP_TIME :
				{
					send_command dvTP, "'@AKP-;Enter Lamp Time'"
				}
				case BTN_SET_WARMUP_TIME :
				{
