...
DEFINE_CALL 'PCInput_On'		//PC INPUT
{
	 ...
	 SEND_COMMAND VIDEO_SWITCHER,"'CI1O1'"		//PC VIDEO IN1 TO OUT1
...
DEFINE_CALL 'LaptopInput_On'		//LAPTOP INPUT
{
	 CALL 'Projector_On'		//PROJECTOR ON
	 CALL 'PresentationLights_On'		//PRESENTATION LIGHTS ON
	 SEND_COMMAND VIDEO_SWITCHER,"'CI2O1'"		//LAPTOP VIDEO IN2 TO OUT1
...
DEFINE_CALL 'CameraInput_On'		//CAMERA INPUT
{
	 CALL 'Projector_On'		//PROJECTOR ON
	 CALL 'PresentationLights_On'		//PRESENTATION LIGHTS ON
	 SEND_COMMAND VIDEO_SWITCHER,"'CI3O1'"		//CAMERA VIDEO IN3 TO OUT1
	 SEND_COMMAND VIDEO_SWITCHER,"'CI3O2'"		//CAMERA VIDEO IN3 TO OUT2
	 SEND_COMMAND VIDEO_SWITCHER,"'AI3O2'"		//CAMERA AUDIO IN3 TO OUT2
}

DEFINE_CALL 'System_Off'		//SWITCH SYSTEM OFF
{
