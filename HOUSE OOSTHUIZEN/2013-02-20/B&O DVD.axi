...
INTEGER DVD_BUTTONS[] =  {8, 9, 10, 11, 100,101,102,103,104,105,
  ...
  PUSH:
	 {
			...
			SWITCH(BUTTON.INPUT.CHANNEL)
			{
				 ...
				 CASE 8: PULSE[dvHDMI_Cinema,cYellow];
				 CASE 9: PULSE[dvHDMI_Cinema,cGreen];
				 CASE 10: PULSE[dvHDMI_Cinema,cRed];
				 CASE 11: PULSE[dvHDMI_Cinema,cBlue];
			}
	 }
}
