...
VOLATILE INTEGER	vGBS_DEVICE_ID_ARRAY[] 	= 	{7,3};
...
BUTTON_EVENT[dvTP,802]				//Garden Lights Off
{
	PUSH:
	{
...
BUTTON_EVENT[dvTP,801]				//Garden Lights On
{
	PUSH:
	{
...
BUTTON_EVENT[dvTP,804]				//Pool Lights Off
{
	PUSH:
	{
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(0)";
...
BUTTON_EVENT[dvTP,803]				//Pool Lights On
{
	PUSH:
	{
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";
...
BUTTON_EVENT[dvR4_1,802]				//Garden Lights Off
{
	PUSH:
	{
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(0)";
...
BUTTON_EVENT[dvR4_1,801]				//Garden Lights On
{
	PUSH:
	{
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";
...
BUTTON_EVENT[dvR4_1,804]				//Pool Lights Off
{
	PUSH:
	{
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(0)";
...
BUTTON_EVENT[dvR4_1,803]				//Pool Lights On
{
	PUSH:
	{
		//SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";
