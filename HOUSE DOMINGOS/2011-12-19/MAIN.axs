...
dvHDMI_Down1							=				 5502:3:0		//HDMI Down1 Bedroom
	...
	TO[dvR4_RM3,BUTTON.INPUT.CHANNEL]
		SWITCH(BUTTON.INPUT.CHANNEL)
		{
			...
			CASE 353:	ON [vdvMatrixAudio[6],199]		//MUTE / POWER OFF
							  PULSE [dvHDMI_Down1,9]		//Switches Sony TV on/off
			CASE 332: SEND_COMMAND dvUTPRO_HDMI,"'CI1O3'"		//Input 1(DSTV) Output 3(Down1)
								SEND_COMMAND vdvMATRIXAUDIO[6],"'INPUTSELECT-5'";		//Input 5(DSTV) Output 6(Down1)
								SEND_LEVEL vdvMATRIXAUDIO[6],1,128;
			CASE 333:	SEND_COMMAND dvUTPRO_HDMI,"'CI3O3'"		//Input 3(TPA) Output 3(Down1)
