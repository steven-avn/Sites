MODULE_NAME='G4CommMod'(DEV vTX_COMMS_DEVICE_ARRAY[], INTEGER vTX_COMMS_DEVICE_ID_ARRAY[], INTEGER TOTAL_NODE_COUNT, DEV TX_COMMS_DEVICE, DEV RX_COMMS_DEVICE, CHAR GBS_TX_IP_ADDRESS[], INTEGER GBS_IP_PORT, INTEGER LIGHTING_LEVELS[][], INTEGER SWITCH_STATES[][], INTEGER MODULE_VERSION, INTEGER DEBUG, INTEGER INDIVIDUAL_DEBUGS[])
(***********************************************************)
(*  FILE CREATED ON: 05/29/2012  AT: 12:42:29              *)
(***********************************************************)
(***********************************************************)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 09/10/2012  AT: 13:10:24        *)
...
LOCAL_VAR VOLATILE CHAR CHECKSUM
	...
	SELECT
	{
		...
		//THIS IS USED TO ACHIEVE DIMMING LEVELS
		{
			...
			IF (TEMP_ZONE)
			{
				...
				IF (COMMS_MODE == 1)
					GB_CONVERTED_COMMAND = "192,168,10,251,'SMARTCLOUD',ADD_CRC("$AA,$AA,$0F,$01,$FE,$00,$FE,$00,$31,$01,GB_ADDRESS,TEMP_ZONE,TEMP_LEVEL,$00,$00")"
