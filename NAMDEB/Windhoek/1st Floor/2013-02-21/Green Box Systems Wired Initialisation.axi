...
VOLATILE INTEGER	vGBS_DEVICE_ID_ARRAY[] 	= 	{10,11};
...
VOLATILE CHAR			GBS_TX_IP_ADDRESS[] 		= '192.168.1.250';

VOLATILE INTEGER iDimmer1Channel1Level;
VOLATILE INTEGER PresentationMode = 0;
VOLATILE INTEGER VCMode = 0;
...
DEFINE_MODULE 'G4CommMod' EXAMPLE_INSTANCE (vGBS_DEV_ARRAY, vGBS_DEVICE_ID_ARRAY, GBS_NODE_COUNT, dvGBS_IP_TX_DEVICE, dvGBS_IP_RX_DEVICE, GBS_TX_IP_ADDRESS, GBS_IP_PORT, GBS_LIGHTING_LEVELS, GBS_SWITCH_STATES, GBS_MODULE_VERSION, GBS_DEBUG, GBS_INDIVIDUAL_DEBUGS);
...
//	
//	IF(iDimmer1Channel1Level == 100 && PresentationMode == 0)
//	{
//		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";
//		SEND_COMMAND vGBS_DEV_ARRAY[2],"'L:[1]:',ITOA(100)";
//	}
//	ELSE IF(iDimmer1Channel1Level == 100 && PresentationMode == 1)
//	{
//		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(50)";
//		SEND_COMMAND vGBS_DEV_ARRAY[2],"'L:[1]:',ITOA(0)";
//	}
//  ELSE IF(iDimmer1Channel1Level == 100 && VCMode == 1)
//	{
//		SEND_COMMAND vGBS_DEV_ARRAY[1],"'L:[1]:',ITOA(100)";
//		SEND_COMMAND vGBS_DEV_ARRAY[2],"'L:[1]:',ITOA(100)";
//	}
