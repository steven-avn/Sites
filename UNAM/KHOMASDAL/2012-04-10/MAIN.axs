...
dvPROJ1				=		5001:2:0		//SONY EX-100 PROJECTORS
...
SEND_COMMAND dvPROJ1,"'SET BAUD,38400,E,8,1,DISABLE'"		//SONY EX-100, X-Over Cable
SEND_COMMAND dvSMART,"'SET BAUD,19200,N,8,1'"		//Streight Cable,SMART UX60 SMARTBOARD
	 ...
	 PUSH:
	 {
			...
			SWITCH(BUTTON.INPUT.CHANNEL)
			{
				 case 2:	//SEND_STRING dvKRAMER, "$01,$81,$81,$81"		//IN1 TO OUT1 (SMARTBOARD1)
									...
									VOL_LEVEL1	= 30	//Volume1 level for bargraph1
									SEND_LEVEL dvTP1,1,VOL_LEVEL1
									SEND_STRING dvCLOUD1, '<MI,LA40/>'		//MIC LEVEL 50%
									MIC_LEVEL1 = 30		//Mic1 level for bargraph1
									SEND_LEVEL dvTP1,2,MIC_LEVEL1
				 case 3:	CALL 'SmartBoard_Off'
