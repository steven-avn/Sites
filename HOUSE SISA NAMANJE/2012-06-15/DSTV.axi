  ...
  push:
  {
	to[dvR4_1,BUTTON.INPUT.CHANNEL]
		switch(BUTTON.INPUT.CHANNEL)
		{
			...
			case 96: 	pulse[dvHDPVR1,cd4]
								wait 4
								pulse[dvHDPVR1,cd0]
								wait 7
								pulse[dvHDPVR1,cd1]
			case 97: 	pulse[dvHDPVR1,cd4]
								wait 4
								pulse[dvHDPVR1,cd0]
								wait 7
								pulse[dvHDPVR1,cd0]
			case 98:	pulse[dvHDPVR1,cd1]
								wait 4
								pulse[dvHDPVR1,cd7]
								wait 7
								pulse[dvHDPVR1,cd5]
			...
			case 102: pulse[dvHDPVR1,cd1]
								...
								wait 7
								pulse[dvHDPVR1,cd4]
			case 124: pulse[dvHDPVR1,cd2]
								wait 4
								pulse[dvHDPVR1,cd0]
								wait 7
								pulse[dvHDPVR1,cd2]
			case 123: pulse[dvHDPVR1,cd2]
								wait 4
								pulse[dvHDPVR1,cd0]
								wait 7
								pulse[dvHDPVR1,cd1]
