...
// MAIN
button_event[dvR4_1,23]		// Input 2 (PVR)
button_event[dvR4_1,24]		// Input 3 (DVD)
button_event[dvR4_1,25]		// FM source
button_event[dvR4_1,27]		// iPod source
...
button_event[dvR4_1,20]		// tuner preset 5
{
  push:
  {
	to[dvR4_1,BUTTON.INPUT.CHANNEL]
		...
		{
		// MAIN PAGE
			case 23:	send_string dvBose, "$0b,$00,$01,$04,$12,$01,$2c,$01,$00,$00,$30" // Input 2 (DSTV)
			case 24:	send_string dvBose, "$0b,$00,$01,$04,$13,$01,$2c,$01,$00,$00,$31" // Input 3 (DVD
			case 25: send_string dvBose, "$0b,$00,$01,$04,$25,$01,$2c,$01,$00,$00,$07"	// FM source
			case 27: send_string dvBose, "$0b,$00,$01,$04,$07,$01,$2c,$01,$00,$00,$25"	// iPod source
